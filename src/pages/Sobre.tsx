export default function Sobre() {
  return (
    <div className="bg-white rounded-2xl p-7 shadow-sm border border-slate-100">
      <h2 className="font-bold text-slate-900 text-base mb-5 pb-4 border-b border-slate-100"> Sobre o Sistema IRPC</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="bg-slate-50 rounded-xl p-5">
          <h3 className="font-bold text-slate-900 text-sm mb-3">Tecnologias</h3>
